...
var (
	db_server    = [5]string{"ec2-54-86-92-231.compute-1.amazonaws.com", "ec2-54-86-92-228.compute-1.amazonaws.com", "ec2-54-86-94-116.compute-1.amazonaws.com", "ec2-54-86-92-237.compute-1.amazonaws.com", "ec2-54-86-44-78.compute-1.amazonaws.com"}
...
func (s Server) q3(resp http.ResponseWriter, req *http.Request) {
	...
	buffer.WriteString(retweet_users);
