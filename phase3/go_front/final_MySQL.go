...
type Server struct { }
const POOL_SIZE_q2  = 1200
const POOL_SIZE_q3  = 10000
...
//q2 db servers
const db_server_1 = "ec2-54-208-193-72.compute-1.amazonaws.com"
const db_server_2 = "ec2-54-209-163-40.compute-1.amazonaws.com"
const db_server_3 = "ec2-54-209-46-150.compute-1.amazonaws.com"
const db_server_4 = "ec2-54-209-43-205.compute-1.amazonaws.com"
const db_server_5 = "ec2-54-208-219-85.compute-1.amazonaws.com"
//q3 loadbalancer
...
func (s Server) q2(resp http.ResponseWriter, req *http.Request) {
  ...
  if 0 < user_id_int64 && user_id_int64 <= 197834718 {
	...
	fmt.Println("hit")
     ...
     index = index_pool_1[0]
     index_pool_1 = index_pool_1[1:len(index_pool_1)]
	...
	fmt.Println("hit")
     ...
     index = index_pool_2[0]
     index_pool_2 = index_pool_2[1:len(index_pool_2)]
	...
	fmt.Println("hit")
     ...
     index = index_pool_3[0]
     index_pool_3 = index_pool_3[1:len(index_pool_3)]
	...
	fmt.Println("hit")
     ...
     index = index_pool_4[0]
     index_pool_4 = index_pool_4[1:len(index_pool_4)]
	...
	fmt.Println("hit")
     ...
     index = index_pool_5[0]
     index_pool_5 = index_pool_5[1:len(index_pool_5)]
